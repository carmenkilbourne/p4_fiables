...
HD_PWD='C:/Users/031_svalderramaf/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sma_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sma_filter.tcl
